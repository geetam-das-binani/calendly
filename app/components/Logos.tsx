...
import cloudinaryLogo from "@/public/cloudinary.png";
const Logos = () => {
  return (
    <div className="py-10">
      ...
      <div className="mt-10 grid max-w-lg mx-auto grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
        ...
        <Image
          ...
          max-h-36 w-full object-contain lg:col-span-1 dark:invert"
        />
        <Image
          src={supabaseLogo}
          alt="Logo"
          className="col-span-2 
    max-h-28 w-full object-contain lg:col-span-1 dark:invert"
        />
        <Image
          src={cloudinaryLogo}
          alt="Logo"
